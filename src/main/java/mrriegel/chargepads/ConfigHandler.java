...
public class ConfigHandler {
	...
	public static void refreshConfig(File file) {
		...
		showEnergy = config.getBoolean("showEnergy", Configuration.CATEGORY_CLIENT, !Loader.isModLoaded("theoneprobe"), "Shows energy in machines while sneaking.");
		healAnimals = config.getBoolean("healAnimals", Configuration.CATEGORY_GENERAL, true, "Heal animals too.");
		healMonsters = config.getBoolean("healMonsters", Configuration.CATEGORY_GENERAL, true, "Heal monsters too.");
